...
import {backIcon, logo2, msg, sms} from '../../../Utils/img';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.container2}>
        ...
        <Text style={styles.toConfirmYourContainer}>
          To confirm your mail address,please
        </Text>
        <Text style={styles.toConfirmYourContainer}>
           enter the OTP sent to <Text style={styles.emailText}>x***23@gmail.com</Text>
        </Text>
      </View>
        ...
        <Button
          icon={msg}
          title="Resend OTP"
          btnStyle={styles.msgTxt}
          style={styles.resendBtn}
          iconStyle={styles.msgStyle}
        />
